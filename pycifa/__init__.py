...
__all__ = [savemat, loadmat, addStringInFilename, pyHeadExtract, cobe,
           cobec, pcobe, cobe_classify, cnfe, constructW, GNMF, GNMF_Multi,
           JIVE, JIVE_RankSelect, call_mcca, accuracy, CalcSIR, MutualInfo,
           mmc_nonnegative, PMFsobi, tsne, tsne_p, d2p]
